...
GraphQL gibt es in den Dateien `restclient\graphql\pflanzen.query.http` und
`restclient\graphql\pflanzen.mutation.http`.
...
`Dockerfile` das Docker-Image `juergenzimmermann/pflanze:1.0.0` gebaut.
...
mit einer leeren Collection (z.B. `Pflanze`):

```TXT
mongo "mongodb+srv://Lasse:G1bson123@cluster0.8j9ph.mongodb.net/test?retryWrites=true&w=majority"
  use acme
  db.createCollection('Pflanze')
  exit
```


mongodb+srv://Lasse:<password>@cluster0.8j9ph.mongodb.net/acme?retryWrites=true&w=majority
...
`https://gener-iert-12345.herokuapp.com/pflanzen/00000000-0000-0000-0000-000000000001`
zugegriffen.
